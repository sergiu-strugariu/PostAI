...
<template>
    <AdminLayout>
        <div class="max-w-7xl mx-auto">
            <div class="m-6">
                <h1 class="text-4xl mb-4">General Stats</h1>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="m-6">
                <h1 class="text-4xl mb-4">Orders Stats</h1>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="m-6">
                <h1 class="text-4xl mb-4">Orders Revenue</h1>

                <div class="flex flex-wrap -mx-6">
                    <div class="w-full mt-6 px-6 sm:w-1/2 xl:mt-0">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                            <div class="space-y-2">
                                <div
                                    class="flex items-center space-x-2 rtl:space-x-reverse text-sm font-medium text-gray-500">
...
export default {
    props: {
        ...
        ordersProccesing: Number,
        ordersOnHold: Number,

        ordersDeliveredRevenue: String,
