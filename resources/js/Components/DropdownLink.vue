...
<template>
    <div>
        ...
        <Link v-else :href="href" class="text-gray-400 hover:text-white hover:bg-gray-900 block px-4 py-2 text-sm leading-5 focus:outline-none transition duration-150 ease-in-out">
            <slot />
        </Link>
    </div>
</template>
