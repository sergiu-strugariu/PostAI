    ...
    <div
        ...
        <form class="flex flex-col gap-4">
            ...
            <div class="flex justify-center align-center items-center">
                ...
                <div class="absolute">
                    <svg @click="modalBoolean('textarea')" class="w-8 h-8 fill-gray-500 dark:fill-gray-400 hover:fill-amber-300 hover:cursor-pointer" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex justify-between w-full ">
                <svg @click="modalBoolean('search')" class="w-8 h-8 stroke-gray-500 dark:stroke-gray-500 hover:fill-amber-300 hover:cursor-pointer" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg @click="modalBoolean('media')" class="w-8 h-8 fill-gray-500 dark:fill-gray-400 hover:fill-amber-300 hover:cursor-pointer" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
                    <path d="M208.8584,144a15.85626,15.85626,0,0,1-10.46778,15.01367l-52.16015,19.2168-19.2168,52.16015a16.00075,16.00075,0,0,1-30.02734,0l-19.2168-52.16015-52.16015-19.2168a16.00075,16.00075,0,0,1,0-30.02734l52.16015-19.2168,19.2168-52.16015a16.00075,16.00075,0,0,1,30.02734,0l19.2168,52.16015,52.16015,19.2168A15.85626,15.85626,0,0,1,208.8584,144ZM152,48h16V64a8,8,0,0,0,16,0V48h16a8,8,0,0,0,0-16H184V16a8,8,0,0,0-16,0V32H152a8,8,0,0,0,0,16Zm88,32h-8V72a8,8,0,0,0-16,0v8h-8a8,8,0,0,0,0,16h8v8a8,8,0,0,0,16,0V96h8a8,8,0,0,0,0-16Z"/>
                </svg>
            </div>
    ...
    <Modal :show="boolean">
        <div class="bg-gray-800 p-4">
            ...
            <div class="flex justify-between items-center gap-4 mt-4">
                <button type="button" class=" flex-1 h-100 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                    Save
                </button>
                <button @click="modalBoolean" type="button" class=" flex-1 h-100 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                    Close
                </button>
            </div>
        </div>
    ...
    methods: {
        handleFileUpload(event) {
            for (let i = 0; i < event.target.files.length; i++) {
                this.PostForm.orderedFiles.push(
